...
const ContactModal = ({ isOpen, onClose, service, onSendMessage }) => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			// Obtener el nombre del proveedor de la respuesta o usar el del servicio
			const responseProviderName =
				response?.data?.providerName || service.user_name;
			setProviderName(responseProviderName);

			// Cerrar modal de contacto y mostrar modal de éxito
			onClose();
			setMessage("");
