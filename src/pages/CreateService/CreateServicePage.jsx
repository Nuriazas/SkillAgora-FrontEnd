...
const CreateServicePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await handleCreateService(serviceData, authToken);
      navigate("/");
    } catch (error) {
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Development">
                      {t("createService.categories.webDev")}
                    </option>
                    <option value="UI/UX">
                      {t("createService.categories.uiUx")}
                    </option>
                    <option value="Backend">
                      {t("createService.categories.backend")}
                    </option>
                    <option value="DevOps">
                      {t("createService.categories.devops")}
                    </option>
                    <option value="Digital Marketing">
                      {t("createService.categories.digitalMarketing")}
                    </option>
                    <option value="Cybersecurity">
                      {t("createService.categories.cybersecurity")}
                    </option>
                  </select>
                </div>
              </div>
